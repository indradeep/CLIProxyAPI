...
type RemoteManagement struct {
	...
	// PublicCallbackBaseURL overrides OAuth callback target URLs generated by the management API.
	PublicCallbackBaseURL string `yaml:"public-callback-base-url"`
...
func LoadConfigOptional(configFile string, optional bool) (*Config, error) {
	...
	cfg.RemoteManagement.PublicCallbackBaseURL = strings.TrimSpace(cfg.RemoteManagement.PublicCallbackBaseURL)
